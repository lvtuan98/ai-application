...
SECRET_KEY = 'django-insecure-$(x$d@%2tcdav8$f9b_+dle+ojs$i042hd37srs5%uq2&v-i)&'
...
SPECTACULAR_SETTINGS = {
    ...
    "REDOC_DIST": "SIDECAR",
    # OTHER SETTINGS
    # "PREPROCESSING_HOOKS": ["sidp_api.api_specs.hooks.remove_apis_from_list"],
...
BROKER_URL = os.environ.get(
    "BROKER_URL", default="amqp://test:test@107.120.70.226:5672//"
)

MEDIA_ROOT = os.environ.get(
    "MEDIA_ROOT", default=r"/var/www/example.com/media/"
)
